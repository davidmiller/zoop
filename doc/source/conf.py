# -*- coding: utf-8 -*-
#
# Zoop documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Zoop.tex', u'Zoop Documentation',
...
man_pages = [
    ('index', 'zoop', u'Zoop Documentation',
     [u'David Miller'], 1)
]
...
texinfo_documents = [
  ('index', 'Zoop', u'Zoop Documentation',
   u'David Miller', 'Zoop', 'One line description of project.',
   'Miscellaneous'),
]
